...
<link href="./css/my_profile.css" rel="stylesheet" type="text/css">
</head>
<body>
	...
	<form action="update_my_profile_personal?page_from=my_profile.jsp" method="post">
	<div class="content">
		...
		<div class="remove_image">
			<a href="remove_image?page_from=my_profile.jsp">Remove Image</a>
		</div>
	...
	<div class="upload_profile_logo" id="upload_profile_logo">
		<div class="upload_form">
			...
			<form action="upload_profile_picture?page_from=my_profile.jsp" method="post" enctype="multipart/form-data">
