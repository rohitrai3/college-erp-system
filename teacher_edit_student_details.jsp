...
<link href="./css/teacher_edit_student_details.css" rel="stylesheet" type="text/css">
</head>
<body>
	<form action="update_student_details?from=teacher" method="post">
	<div class="content">
	...
	<div class="student_upload_profile_logo" id="student_upload_profile_logo">
		<div class="student_upload_form">
			<div class="student_text">
				...
				<form action="upload_student?from=teacher&who=student&user_id=<%= user_id %>" method="post" enctype="multipart/form-data">
	...
	<div class="f_pic_upload_profile_logo" id="f_pic_upload_profile_logo">
		<div class="f_pic_upload_form">
			<div class="f_pic_text">
				...
				<form action="upload_student?from=teacher&who=father&user_id=<%= user_id %>" method="post" enctype="multipart/form-data">
					<input type="file" name="profile_pic" id="profile_pic">
					<input type="submit" name="upload" value="UPLOAD" id="submit">
				</form>
	...
	<div class="m_pic_upload_profile_logo" id="m_pic_upload_profile_logo">
		<div class="m_pic_upload_form">
			<div class="m_pic_text">
				...
				<form action="upload_student?from=teacher&who=mother&user_id=<%= user_id %>" method="post" enctype="multipart/form-data">
					<input type="file" name="profile_pic" id="profile_pic">
					<input type="submit" name="upload" value="UPLOAD" id="submit">
				</form>
