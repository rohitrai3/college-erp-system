...
<link href="./css/teacher_update_user.css" rel="stylesheet" type="text/css">
</head>
<body>
	...
	<form action="select_user?from=teacher" method="post">
	...
	<table id="update_user_table">
		...
		if(user_name!=null)
		{
			...
			out.print("<td class=\"col12_row51\"><a href=\"update_details?from=teacher&user_id="+user_email+"\">Update</a></td>");
			out.print("</tr>");
		}
	%>
		<tr class="odd_row">
