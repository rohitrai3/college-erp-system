...
<link href="./css/new_my_profile_disciplinary_history.css" rel="stylesheet" type="text/css">
</head>
<body>
	...
	<input type="hidden" name="page_from" value="new_my_profile_disciplinary_history.jsp">
		<div class="content">
