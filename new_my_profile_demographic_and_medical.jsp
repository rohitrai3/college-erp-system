...
<link href="./css/new_my_profile_demographic_and_medical.css" rel="stylesheet" type="text/css">
</head>
<body>
	...
	<input type="hidden" name="page_from" value="new_my_profile_demographic_and_medical.jsp">
		<div class="content">
