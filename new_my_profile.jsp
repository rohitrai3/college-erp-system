...
<%
	...
	String profile_logo=(String)request.getAttribute("profile_logo");
...
<link href="./css/new_my_profile.css" rel="stylesheet" type="text/css">
</head>
<body onload="checkMarital()">
	...
	<form action="update_my_profile_personal?page_from=new_my_profile.jsp" method="post">
	<div class="content">
		<div class="profile_nav">
			<div class="profile_nav_personal"  id="profile_nav_active">
				<strong><a href="new_my_profile_personal?page_from=new_my_profile.jsp&user_id=<%= employee_id %>">Personal</a></strong>
			</div>
		...
		<div class="profile_logo" onclick="uploadShow()">
			<img src="./images/user/<%= profile_logo %>" alt="<%= profile_logo %>" id="profile_logo">
		</div>
		<div class="remove_image">
			<a href="remove_image?page_from=new_my_profile.jsp">Remove Image</a>
		</div>
	...
	<div class="upload_profile_logo" id="upload_profile_logo">
		<div class="upload_form">
			...
			<form action="upload_profile_picture?page_from=new_my_profile.jsp" method="post" enctype="multipart/form-data">
