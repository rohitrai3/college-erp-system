...
<link href="./css/my_profile_additional_information.css" rel="stylesheet" type="text/css">
</head>
<body>
	...
	<input type="hidden" name="page_from" value="my_profile_additional_information.jsp">
	<div class="content">
